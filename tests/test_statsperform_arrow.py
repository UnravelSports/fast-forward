...
class TestStatsperformArrowInputContract:
    ...
    def test_accepts_buffered_reader(self, raw_bytes, meta_json_bytes, tmp_path):
        assert_arrow_accepts_buffered_reader(_stp_load_arrow, tmp_path, raw_bytes, meta_json_bytes)

    def test_accepts_gzip_stream(self, raw_bytes, meta_json_bytes):
        assert_arrow_accepts_gzip_stream(_stp_load_arrow, raw_bytes, meta_json_bytes)
