...
class TestTracabArrowInputContract:
    ...
    def test_accepts_buffered_reader(self, raw_bytes, meta_bytes, tmp_path):
        assert_arrow_accepts_buffered_reader(_tracab_load_arrow, tmp_path, raw_bytes, meta_bytes)

    def test_accepts_gzip_stream(self, raw_bytes, meta_bytes):
        assert_arrow_accepts_gzip_stream(_tracab_load_arrow, raw_bytes, meta_bytes)
