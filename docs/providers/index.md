...
fast-forward supports 12 tracking data providers. Each provider has a `load_tracking()` function that returns a [`TrackingDataset`](../concepts/dataset.md).
...
| [SciSports](scisports.md) | 2 | EPTS XML + Text | SportVU | long, long_ball, wide | none |
